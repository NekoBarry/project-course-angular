...
export class RecipeEditComponent implements OnInit {
  ...
  private initForm() {
    let { recipeName, recipeImagePath, recipeDescription, recipeIngredients } = this.initializeControlValues();
      ...
      if (recipe['ingredients']) {
        for (let ingredient of recipe.ingredients) {
          recipeIngredients.push(new FormGroup({
            ...
            'amount': new FormControl(ingredient.amount, this.createAmountValidators())
          }));
        }
      }
    }
  ...
  private createAmountValidators() {
